                  ...
                  child: Card(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(details.name.toUpperCase(),style: TextStyle(fontSize: 25),),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: details.types.map((type) => _pokemonTypeView(type)).toList(),
                        ),
                        Text('ID: ${details.id} - Peso: ${details.weight} - Altura: ${details.height} ',style: TextStyle(fontSize: 25),)
                  ...
                  child: SizedBox(
                    ...
                    child: Card(
                      child: Padding(
                        ...
                        child: Text(details.description, style: TextStyle(fontSize: 25), textAlign: TextAlign.center,),
                      ),
                    ),)
                ),
              ],
